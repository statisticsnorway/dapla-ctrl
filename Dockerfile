...
COPY --from=builder --chown=nonroot:nonroot --chmod=777 /usr/local/app/node_modules /app/node_modules
COPY --from=builder --chown=nonroot:nonroot --chmod=777 /usr/local/app/package*.json /usr/local/app/server.js /app/

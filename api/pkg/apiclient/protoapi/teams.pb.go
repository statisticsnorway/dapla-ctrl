...
type Team struct {
	...
	HasManualEditing     bool                   `protobuf:"varint,2,opt,name=has_manual_editing,json=hasManualEditing,proto3" json:"has_manual_editing,omitempty"`
...
func (b0 Team_builder) Build() *Team {
	...
	_, _ = b, x
	x.Slug = b.Slug
	x.HasManualEditing = b.HasManualEditing

...
const (
	Reconcilers_Register_FullMethodName                     = "/dapla.api.protobuf.Reconcilers/Register"
	Reconcilers_Get_FullMethodName                          = "/dapla.api.protobuf.Reconcilers/Get"
	Reconcilers_List_FullMethodName                         = "/dapla.api.protobuf.Reconcilers/List"
	Reconcilers_Config_FullMethodName                       = "/dapla.api.protobuf.Reconcilers/Config"
	Reconcilers_SetReconcilerErrorForTeam_FullMethodName    = "/dapla.api.protobuf.Reconcilers/SetReconcilerErrorForTeam"
	Reconcilers_RemoveReconcilerErrorForTeam_FullMethodName = "/dapla.api.protobuf.Reconcilers/RemoveReconcilerErrorForTeam"
	Reconcilers_SuccessfulTeamSync_FullMethodName           = "/dapla.api.protobuf.Reconcilers/SuccessfulTeamSync"
	Reconcilers_SaveState_FullMethodName                    = "/dapla.api.protobuf.Reconcilers/SaveState"
	Reconcilers_State_FullMethodName                        = "/dapla.api.protobuf.Reconcilers/State"
	Reconcilers_DeleteState_FullMethodName                  = "/dapla.api.protobuf.Reconcilers/DeleteState"
)
...
func (UnimplementedReconcilersServer) SetReconcilerErrorForTeam(context.Context, *SetReconcilerErrorForTeamRequest) (*SetReconcilerErrorForTeamResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetReconcilerErrorForTeam not implemented")
}
func (UnimplementedReconcilersServer) RemoveReconcilerErrorForTeam(context.Context, *RemoveReconcilerErrorForTeamRequest) (*RemoveReconcilerErrorForTeamResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveReconcilerErrorForTeam not implemented")
}
func (UnimplementedReconcilersServer) SuccessfulTeamSync(context.Context, *SuccessfulTeamSyncRequest) (*SuccessfulTeamSyncResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SuccessfulTeamSync not implemented")
}
...
func RegisterReconcilersServer(s grpc.ServiceRegistrar, srv ReconcilersServer) {
	// If the following call panics, it indicates UnimplementedReconcilersServer was
...
var Reconcilers_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dapla.api.protobuf.Reconcilers",

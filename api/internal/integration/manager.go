...
import (
	...
	"github.com/statisticsnorway/dapla-ctrl/api/internal/graph"
...
func TestRunner(ctx context.Context, skipSetup bool) (*testmanager.Manager, func(), error) {
	...
	mgr, err := testmanager.New(newConfig, newManager(ctx, container, connStr, skipSetup), &runner.GQL{}, &runner.SQL{}, &runner.PubSub{})
	if err != nil {
		return nil, func() {}, err
	}

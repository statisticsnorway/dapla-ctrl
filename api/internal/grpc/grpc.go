...
import (
	...
	"github.com/statisticsnorway/dapla-ctrl/api/internal/grpc/grpcatlantis"
	...
	"github.com/statisticsnorway/dapla-ctrl/api/internal/grpc/grpcteam"
	"github.com/statisticsnorway/dapla-ctrl/api/internal/grpc/grpcuser"
...
func Run(ctx context.Context, listenAddress string, pool *pgxpool.Pool, log logrus.FieldLogger) error {
	...
	protoapi.RegisterAtlantisServer(s, grpcatlantis.NewServer(pool))

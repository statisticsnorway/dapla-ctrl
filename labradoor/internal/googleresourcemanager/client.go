...
func (c *GoogleCloudResourceManager) AddBinding(ctx context.Context, projectID, member, role string) {
	...
	c.setPolicy(ctx, projectID, policy)
}

// RemoveMember removes the principal from the project's IAM policy
func (c *GoogleCloudResourceManager) RemoveMember(ctx context.Context, projectID, member, role string) {

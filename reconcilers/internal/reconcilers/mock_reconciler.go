...
import (
	...
	apiclient "github.com/statisticsnorway/dapla-ctrl/api/pkg/apiclient"

	logrus "github.com/sirupsen/logrus"

	mock "github.com/stretchr/testify/mock"

	protoapi "github.com/statisticsnorway/dapla-ctrl/api/pkg/apiclient/protoapi"
)
...
// Delete provides a mock function with given fields: ctx, client, daplaTeam, log
func (_m *MockReconciler) Delete(ctx context.Context, client *apiclient.APIClient, daplaTeam *protoapi.Team, log logrus.FieldLogger) error {
	ret := _m.Called(ctx, client, daplaTeam, log)
	...
	if rf, ok := ret.Get(0).(func(context.Context, *apiclient.APIClient, *protoapi.Team, logrus.FieldLogger) error); ok {
		r0 = rf(ctx, client, daplaTeam, log)
	} else {
		r0 = ret.Error(0)
	}
...
//   - daplaTeam *protoapi.Team
//   - log logrus.FieldLogger
func (_e *MockReconciler_Expecter) Delete(ctx interface{}, client interface{}, daplaTeam interface{}, log interface{}) *MockReconciler_Delete_Call {
	return &MockReconciler_Delete_Call{Call: _e.mock.On("Delete", ctx, client, daplaTeam, log)}
}

func (_c *MockReconciler_Delete_Call) Run(run func(ctx context.Context, client *apiclient.APIClient, daplaTeam *protoapi.Team, log logrus.FieldLogger)) *MockReconciler_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
// Reconcile provides a mock function with given fields: ctx, client, daplaTeam, log
func (_m *MockReconciler) Reconcile(ctx context.Context, client *apiclient.APIClient, daplaTeam *protoapi.Team, log logrus.FieldLogger) error {
	ret := _m.Called(ctx, client, daplaTeam, log)
...
//   - daplaTeam *protoapi.Team
//   - log logrus.FieldLogger
func (_e *MockReconciler_Expecter) Reconcile(ctx interface{}, client interface{}, daplaTeam interface{}, log interface{}) *MockReconciler_Reconcile_Call {
	return &MockReconciler_Reconcile_Call{Call: _e.mock.On("Reconcile", ctx, client, daplaTeam, log)}
}

func (_c *MockReconciler_Reconcile_Call) Run(run func(ctx context.Context, client *apiclient.APIClient, daplaTeam *protoapi.Team, log logrus.FieldLogger)) *MockReconciler_Reconcile_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*apiclient.APIClient), args[2].(*protoapi.Team), args[3].(logrus.FieldLogger))
	})
	return _c
